...
interface ClotheCommentsProps {
	commentGroup: CommentGroup;
	commentRefId: string;
	memberId?: string;
}

const ClotheComments = (props: ClotheCommentsProps) => {
		...
		<Stack className="comments-wrap">
			...
			<Box className="comment-input-area">
				<textarea
					...
					placeholder={memberId ? 'How does this fit? Share your review...' : 'Sign in to comment'}
