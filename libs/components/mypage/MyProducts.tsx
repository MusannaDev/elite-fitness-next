...
import { TrainerProductsInquiry } from '../../types/product/product.input';
import { T } from '../../types/common';
import { ProductStatus } from '../../enums/product.enum';
import { userVar } from '../../../apollo/store';
import { useRouter } from 'next/router';
import { GET_TRAINER_PRODUCTS } from '../../../apollo/user/query';
...
const MyProducts: NextPage = ({ initialInput, ...props }: any) => {
	...
	if (device === 'mobile') {
		return <div>MEMBER PRODUCTS MOBILE</div>;
	} else {
		return (
			<div id="my-products-page">
				<Stack className="main-title-box">
					<Stack className="right-box">
						...
						<Typography className="sub-title">Manage your training products</Typography>
					</Stack>
				</Stack>
